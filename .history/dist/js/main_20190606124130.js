$(document).ready(function() {
  ...
  $('.choice_button').find('.individual').addClass('active');
  ...
  $('.choice_buttons').find('.individual').on('click', function(){
    ...
    $(this).closest('.choice_button').removeClass('active');
    $(this).siblings().removeClass('active');
    console.log('button individual clicked');
  });
  $('.choice_buttons').find('.company').on('click', function(){
    console.log('button company clicked');
  });
  // $('.choice_button').find('.individual').on('click', function(){
  //   $(this).addClass('active');
